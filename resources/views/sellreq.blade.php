  ...
  <main id="main">
    ...
    <section id="sel-req-div">
        <div class="form-wrapper">
            <p class="title">@lang('app.a home and you will help sell your home')</p>
            <p class="desc">
            @if(App::getLocale()=="en")
            {!! nl2br(setting('site.text_en_sellrequest')) !!}
            @elseif(App::getLocale()=="pt")
            {!! nl2br(setting('site.text_pt_sellrequest')) !!}
            @endif
            </p>

            <div class="form">
                <form action="{{ route('sellrequest.store') }}" method="POST" role="form" class="contactForm">
                  @csrf
                  @if (session('status'))
